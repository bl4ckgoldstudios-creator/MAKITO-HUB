...
function UIModule.CreateHub()
    ...
    UIModule.NewSection(MainTab, "Quest & Race")
    UIModule.NewToggle(MainTab, "Auto Race V2 (Flowers)", "AutoRaceV2")
    UIModule.NewToggle(MainTab, "Auto Race V3 (Arowe)", "AutoRaceV3")
    UIModule.NewToggle(MainTab, "Auto Cyborg (Core Brain)", "AutoCyborg")
    UIModule.NewToggle(MainTab, "Auto Random Bone (Death King)", "AutoRandomBone")
