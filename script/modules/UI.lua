...
function UIModule.CreateHub()
    ...
    local MainTab = UIModule.NewTab("Auto Farm", TabContainer, ContentArea)
    UIModule.NewSection(MainTab, "Farming Elite (Global)")
    UIModule.NewToggle(MainTab, "Supreme Auto Farm", "AutoFarmLevel")
    UIModule.NewToggle(MainTab, "Kill Aura Elite (Silent)", "KillAura")
    ...
    if _G.MakitoSea == 1 then
        UIModule.NewSection(MainTab, "Sea 1 - World Items")
        UIModule.NewToggle(MainTab, "Auto Saber", "AutoSaber")
        UIModule.NewToggle(MainTab, "Auto Pole (Thunder God)", "AutoPole")
        UIModule.NewToggle(MainTab, "Auto Shop All (Sea 1)", "AutoBuySea1")
    elseif _G.MakitoSea == 2 then
        UIModule.NewSection(MainTab, "Sea 2 - World Items")
        UIModule.NewToggle(MainTab, "Auto Race V2 (Flowers)", "AutoRaceV2")
        UIModule.NewToggle(MainTab, "Auto Race V3 (Arowe)", "AutoRaceV3")
        UIModule.NewToggle(MainTab, "Auto Law (Order Boss)", "AutoLaw")
        UIModule.NewToggle(MainTab, "Auto Rengoku (Ice Castle)", "AutoRengoku")
        UIModule.NewToggle(MainTab, "Auto Factory", "AutoFactory")
        UIModule.NewToggle(MainTab, "Auto Bartilo Quest", "AutoBartilo")
    elseif _G.MakitoSea == 3 then
        UIModule.NewSection(MainTab, "Sea 3 - End Game")
        UIModule.NewToggle(MainTab, "Auto Dough King / Prince", "AutoDoughKing")
        UIModule.NewToggle(MainTab, "Auto CDK (Puzzle)", "AutoCDK")
        ...
        UIModule.NewToggle(MainTab, "Auto Shark Anchor", "AutoSharkAnchor")
    ...
    UIModule.NewSection(MainTab, "Automation Config")
    UIModule.NewSlider(MainTab, "Kill Aura Distance", 50, 300, 150, "KillAuraDistance")
    UIModule.NewSlider(MainTab, "Farm Distance Offset", 0, 30, 12, "Distance")

    local CombatTab = UIModule.NewTab("Combat / PVP", TabContainer, ContentArea)
    UIModule.NewSection(CombatTab, "Attack Framework")
    UIModule.NewToggle(CombatTab, "Fast Attack (Fast + Kill Aura)", "FastAttack")
    ...
    UIModule.NewToggle(SeaTab, "Auto Blue Gear (Mirage)", "AutoFindGear")
    UIModule.NewToggle(SeaTab, "Auto Mirage Chests", "AutoMirageChests")
    UIModule.NewToggle(SeaTab, "Auto Mirage Dealer", "AutoMirageDealer")
    UIModule.NewSection(SeaTab, "World Events")
    UIModule.NewToggle(SeaTab, "Auto Darkbeard", "AutoDarkbeard")
    UIModule.NewToggle(SeaTab, "Auto Law", "AutoLaw")
